...
% interval_size: This is the size of the interval
% iter_or_interval_size: Select whether you want to solve this problem by
% using number of iterations or interval size 
...
function [optimization_history, function_history, dis, final_interval, final_result] = golden_section_optimization(equation, initial_point, final_point, iteration_number, interval_size, iter_or_interval_size, Min_or_Max)
...
elseif iter_or_interval_size == "interval_size"
d = x2 - x1;
